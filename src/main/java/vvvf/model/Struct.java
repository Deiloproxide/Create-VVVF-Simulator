...
public final class Struct {
    ...
    public static class Domain {
        ...
        private DeltaSigma[] deltaSigmaInstances = new DeltaSigma[]{new DeltaSigma(), new DeltaSigma(), new DeltaSigma()};
    ...
    public static class ElectricalParameter {
        ...
        public ElectricalParameter(
                boolean isNone,
                boolean isZeroOutput,
                int pwmLevel,
                PulseControl pulsePattern,
                CarrierParameter carrierFrequency,
                Map<PulseControl.Pulse.PulseDataKey, Double> pulseData,
                double baseWaveFrequency,
                Double baseWaveAmplitude
        ) {
            this.isNone = isNone;
        ...
        public ElectricalParameter copy() {
            return new ElectricalParameter(
                    isNone,
                    isZeroOutput,
                    pwmLevel,
                    pulsePattern == null ? null : pulsePattern.copy(),
                    carrierFrequency == null ? null : carrierFrequency.copy(),
                    pulseData == null ? null : new HashMap<>(pulseData),
                    baseWaveFrequency,
                    baseWaveAmplitude
            );
        }
        ...
        public static class CarrierParameter {
            ...
            public CarrierParameter copy() {
                ...
                if (base instanceof ConstantFrequency constant) {
                    base = constant.copy();
                } else if (base instanceof VibratoFrequency vibrato) {
                    base = vibrato.copy();
                }
    ...
    public static class PhaseState {
        ...
        public boolean equals(Object obj) {
            if (!(obj instanceof PhaseState other)) {
                return false;
            }
