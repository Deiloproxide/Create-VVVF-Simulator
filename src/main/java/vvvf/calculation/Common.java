...
public final class Common {
    ...
    public interface PhaseStateCalculator {
        Struct.PhaseState calculate(Struct.Domain control, double initialPhase);
    }
    ...
    public static double getPulseDataValue(Map<PulseDataKey, Double> pulseData, PulseDataKey key) {
        if (pulseData == null) {
            return Config.getPulseDataKeyDefaultConstant(key);
        }
        return pulseData.getOrDefault(key, Config.getPulseDataKeyDefaultConstant(key));
    }

    public static double discreteTimeLine(double x, int level, Struct.PulseControl.Pulse.DiscreteTimeConfiguration.DiscreteTimeMode mode) {
    ...
    public static BaseWaveParameter getBaseWaveParameter(Struct.Domain control, int phase, double initialPhase) {
        if (control.electricalState.isNone) {
            return new BaseWaveParameter(0, 0);
        }
    ...
    public static double getBaseWaveform(Struct.Domain control, int phase, double initialPhase) {
        if (control.electricalState.isNone || control.electricalState.baseWaveAmplitude == null) {
            return 0;
        }
        ...
        if (baseWaveType == BaseWaveType.DPWM30 || baseWaveType == BaseWaveType.DPWM60C || baseWaveType == BaseWaveType.DPWM60P
                || baseWaveType == BaseWaveType.DPWM60N || baseWaveType == BaseWaveType.DPWM120P || baseWaveType == BaseWaveType.DPWM120N) {
            ...
            return switch (baseWaveType) {
                case DPWM30 -> switch (sector6) {
                    case 0, 9 -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                    case 1, 4 -> 1;
                    case 2, 11 -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                    case 3, 6 -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                    case 5, 8 -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                    default -> -1;
                };
                case DPWM60C -> switch (sector3) {
                    case 0 -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                    case 1 -> 1;
                    case 2 -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                    case 3 -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                    case 4 -> -1;
                    default -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                };
                case DPWM60P -> switch (sector6) {
                    case 1, 2 -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                    case 3, 4 -> 1;
                    case 5, 6 -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                    case 7, 8 -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                    case 9, 10 -> -1;
                    default -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                };
                case DPWM60N -> switch (sector6) {
                    case 1, 2 -> 1;
                    case 3, 4 -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                    case 5, 6 -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                    case 7, 8 -> -1;
                    case 9, 10 -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                    default -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                };
                case DPWM120P -> switch (sector6) {
                    case 1, 2, 3, 4 -> 1;
                    case 5, 6, 7, 8 -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                    default -> amp * MyMath.Functions.sine(x) + (1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                };
                case DPWM120N -> switch (sector6) {
                    case 3, 4, 5, 6 -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase + MyMath.M_2PI_3).x()));
                    case 7, 8, 9, 10 -> -1;
                    default -> amp * MyMath.Functions.sine(x) + (-1 - amp * MyMath.Functions.sine(getBaseWaveParameter(control, phase, initialPhase - MyMath.M_2PI_3).x()));
                };
                default -> 0;
        ...
        double baseWave = amp * switch (baseWaveType) {
    ...
    public static double getCarrierWaveform(Struct.Domain control, double time) {
        if (control.electricalState.isNone) {
            return 0;
        }
    ...
    public static Struct.PhaseState calculatePhsaseState(Struct.Domain control, double initialPhase) {
        Struct.PhaseState state = Struct.PhaseState.zero();
        if (!control.electricalState.isNone && !control.electricalState.isZeroOutput) {
            state = getCalculator(control.electricalState.pwmLevel, control.electricalState.pulsePattern.pulseMode.pulseType)
                    .calculate(control, initialPhase);
        }
