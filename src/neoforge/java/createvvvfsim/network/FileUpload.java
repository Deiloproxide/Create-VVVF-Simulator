...
public record FileUpload(int slot_num,String file_type,String file_name,byte[] content) implements IModel{
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf,FileUpload> codec=StreamCodec.composite(
